...
<head>
    ...
    <link rel="icon" href="assets/img/starbhak.png">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                <div>
                    ...
                    <div style="background-color: white; border-radius:10%;">
                        <img class="" src="/assets/img/starbhak.png" style="width: 30px;">
                    </div>
                    {{-- <img class="img-profile rounded-circle" src="/assets/img/logojagad.png"> --}}
                    
                </div>
                <div class="sidebar-brand-text mx-3">STARBHAK<sup>SPP</sup></div>
            </a>
